    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading"> <strong class="">Human Resource Management System</strong>

                </div>
                <div class="panel-body">

		  			<div class="alert alert-success" role="alert">
                    Well done! You Successfully Installed Human Resource Management System. 
                    </div>
                ...
                <div class="panel-footer">&copy www.fratelloneit.com
                </div>
            </div>
        </div>
    </div>

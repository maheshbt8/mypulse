        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="edit" style="padding: 5px">
                <div class="">
                        ...
                        echo form_open(base_url() . 'index.php?superadmin/manage_language/update_phrase/'.$current_editing_language  , array('id' => 'phrase_form'));
                        $count = 1;
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url();?>index.php?superadmin/manage_language/edit_phrase/<?php echo $field;?>"
                                     class="btn btn-info">
                                        <?php echo get_phrase('edit_phrase');?>
                                </a>
                                <a href="<?php echo base_url();?>index.php?superadmin/manage_language/delete_language/<?php echo $field;?>"
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?superadmin/manage_language/add_phrase/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
            ...
            <div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?superadmin/manage_language/add_language/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">

...
<div class="row">
	<div class="col-md-12">
    	...
    	<!------CONTROL TABS END------>
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?hospitaladmins/add_receptionist/" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function get_department(branch_id) {
      ...
      function get_doctor(branch_id) {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php?ajax/get_doctor/' + branch_id ,
            success: function(response)
            {

<a href="<?php echo base_url(); ?>index.php?hospitaladmins/add_branch/<?= $this->session->userdata('hospital_id');?>"><button onclick="" 
    ...
    <tbody>
        <?php  $i=1;foreach ($branch_info as $row) {?>
            ...
            <a href="<?php echo base_url(); ?>index.php?hospitaladmins/get_hospital_departments/<?php echo $row['branch_id'] ?>" title="Departments"><i class="glyphicon glyphicon-eye-open"></i></a>
                ...
                <td>
            <a href="<?php echo base_url(); ?>index.php?hospitaladmins/edit_branch/<?php echo $row['branch_id'] ?>" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>

...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?hospitaladmins/department/create" method="post" enctype="multipart/form-data">
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
						<label for="field-ta" class="col-sm-3 control-label"><?php echo $this->lang->line('labels')['selectBranch'];?></label>
		                    <div class="col-sm-5">
                                <input type="hidden" name="hospital" value="<?= $branch['hospital_id'];?>">

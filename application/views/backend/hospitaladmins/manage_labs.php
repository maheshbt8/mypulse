...
?>
<form action="<?php echo base_url()?>index.php?hospitaladmins/medical_labs/delete_multiple/" method="post">
...
<button type="button" onclick="window.location.href = '<?php echo base_url();?>index.php?hospitaladmins/add_labs'" class="btn btn-primary pull-right">
        ...
        <?php $i=1;foreach ($lab_info as $row) { ?>   
            <tr>
                ...
                <td><?php echo $row['unique_id'];?></td>
                 <td><a href="<?php echo base_url();?>index.php?hospitaladmins/edit_labs/<?php echo $row['lab_id']?>" class="hiper"><?php echo $row['name'] ?></a></td>
               ...
               <td>
              <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?hospitaladmins/medical_labs/delete/<?php echo $row['lab_id']?>');" title="Delete"><i class="glyphicon glyphicon-remove"></i></a> 
               <?php if($row['is_email'] == '2'){?>
                <a href="<?php echo base_url(); ?>index.php?hospitaladmins/resend_email_verification/medicallabs/lab/<?php echo $row['unique_id'] ?>" title="Verification Mail"><i class="glyphicon glyphicon-envelope"></i></a><?php }?>
                </td>
            </tr>
        <?php } ?>
    </tbody>

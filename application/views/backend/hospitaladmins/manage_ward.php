...
?>
<form action="<?php echo base_url()?>index.php?hospitaladmins/ward/delete_multiple/" method="post">
...
<button type="button" onclick="window.location.href = '<?php echo base_url(); ?>index.php?hospitaladmins/add_ward/<?= $department_id;?>'" class="btn btn-primary pull-right">
        ...
        <?php $i=1;foreach ($ward_info as $row) { ?>   
            <tr>  
                <td><input type="checkbox" name="check[]" class="check" id="check" value="<?php echo $row['ward_id'] ?>"></td>
                 <td><a href="<?php echo base_url(); ?>index.php?hospitaladmins/edit_ward/<?php echo $row['ward_id'] ?>" class="hiper"><?php echo $row['name'] ?></a></td>
                ...
                <td><a href="<?php echo base_url(); ?>index.php?hospitaladmins/get_hospital_bed/<?php echo $row['ward_id'] ?>" title="Beds"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                <td>
            
            <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?hospitaladmins/ward/delete/<?php echo $row['ward_id'] ?>');" title="Delete"><i class="glyphicon glyphicon-remove"></i></a>

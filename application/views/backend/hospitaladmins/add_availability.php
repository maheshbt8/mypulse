...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="<?php echo base_url()?>index.php?hospitaladmins/doctor_availability/update/<?php echo $doctor->doctor_id;?>" method="post" class="form-horizontal form-groups-bordered validate" id="form1" enctype="multipart/form-data">
                ...
                <div class="panel panel-primary " data-collapsed="0">
                    ...
                    <div class="panel-body" style="padding:0px;">
                        <div class="calendar-env">
                            <div class="calendar-body"><button class="btn btn-primary pull-right" onclick="window.location.href = '<?php echo base_url();?>index.php?hospitaladmins/doctor_new_availability/<?php echo $doctor->doctor_id;?>'"><?php echo $this->lang->line('buttons')['addNew'];?></button>
	  ...
	  var calendar = $('#notice_calendar');
				...
				$('#notice_calendar').fullCalendar({
					...
					events: [
						...
						?>
						{
						    url:"<?php echo base_url();?>index.php?hospitaladmins/edit_doctor_new_availability/<?php echo $doctor_id.'/'.$row['id'];?>",

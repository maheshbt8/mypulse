...
?>
<form action="<?php echo base_url()?>index.php?hospitaladmins/bed/delete_multiple/" method="post">
...
<button type="button" onclick="window.location.href = '<?php echo base_url();?>index.php?hospitaladmins/add_bed/<?= $ward_id;?>'" class="btn btn-primary pull-right">
    ...
    <tbody>
        ...
        foreach ($bed_info as $row) { ?>   
            <tr>
                ...
                <td><a href="<?php echo base_url(); ?>index.php?hospitaladmins/edit_bed/<?php echo $row['bed_id'] ?>" class="hiper"><?php echo $row['name'] ?></a></td>
            ...
            <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?hospitaladmins/bed/delete/<?php echo $row['bed_id'] ?>');" title="Delete"><i class="glyphicon glyphicon-remove"></i></a>
                </td>
            </tr>
       <?php $i++; } ?>
    </tbody>

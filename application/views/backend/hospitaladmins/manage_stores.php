...
?>
<form action="<?php echo base_url()?>index.php?hospitaladmins/medical_stores/delete_multiple/" method="post">
...
<button type="button" onclick="window.location.href = '<?php echo base_url();?>index.php?hospitaladmins/add_stores'" class="btn btn-primary pull-right">
        ...
        <?php $i=1;foreach ($store_info as $row) { ?>   
            <tr>
               ...
               <td><?php echo $row['unique_id'];?></td>
                <td><a href="<?php echo base_url();?>index.php?hospitaladmins/edit_stores/<?php echo $row['store_id']?>" class="hiper"><?php echo $row['name'] ?></a></td>
               ...
               <td>
                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?hospitaladmins/medical_stores/delete/<?php echo $row['store_id']?>');" title="Delete"><i class="glyphicon glyphicon-remove"></i></a>
                    <?php if($row['is_email'] == '2'){?>
                <a href="<?php echo base_url(); ?>index.php?hospitaladmins/resend_email_verification/medicalstores/store/<?php echo $row['unique_id'] ?>" title="Verification Mail"><i class="glyphicon glyphicon-envelope"></i></a><?php }?>

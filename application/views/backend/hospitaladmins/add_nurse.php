...
<div class="row">
	<div class="col-md-12">
    	...
    	<!------CONTROL TABS END------>
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?hospitaladmins/add_nurse/" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function get_department(branch_id) {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php?ajax/get_department_all/' + branch_id ,
            success: function(response)
            {
...
if(department_id == 'all'){
    ...
    $.ajax({
            url: '<?php echo base_url();?>index.php?ajax/get_doctor/all/' + branch_id ,
            success: function(response)
            {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php?ajax/get_doctor/' + department_id ,
            success: function(response)
            {
                jQuery('#select_doctor').html(response);
            }

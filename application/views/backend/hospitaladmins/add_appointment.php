...
<div class="row">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?hospitaladmins/unuser/" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        ...
        <!------CONTROL TABS END------>
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?hospitaladmins/add_appointment/" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
   ...
   function get_doctor_ava(unique_id) {
     $.ajax({
            url: '<?php echo base_url();?>index.php?hospitaladmins/get_doctor_data/' + unique_id ,
            success: function(response)
            {
   ...
   function get_dco_date(date_value) {
    var doctor_id=$('#doctor_id').val();
     ...
     $.ajax({
            type : "POST",
            url: '<?php echo base_url();?>index.php?hospitaladmins/get_dco_date/' + doctor_id,
...
<script type="text/javascript">
    ...
    function get_user_data(user_value) {
     ...
     $.ajax({
            type : "POST",
            url: '<?php echo base_url();?>index.php?ajax/get_user_data/' ,
    ...
    function get_specializations_doctors(id) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>index.php?ajax/get_specializations_doctors/' + id ,
            success: function(response)
            {
            jQuery('#doctors').html(response);
            }
    ...
    function get_city_doctors(id) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>index.php?ajax/get_city_doctors/' + id ,
            success: function(response)
            {
            jQuery('#doctors').html(response);
            }

	...
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
				...
				<?php echo get_phrase('district_list'); ?>
                    	</a></li>
			<li>
        ...
        <br>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?superadmin/district/create/' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>

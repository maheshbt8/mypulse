...
<div class="row">
    <div class="col-md-12">
        ...
        <!------CONTROL TABS END------>
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?superadmin/add_hospital_admins/" method="post" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">     
                        ...
                        <div class="col-sm-8">
                            <select name="hospital" class="form-control" id="hospital" data-validate="required" data-message-required="<?php echo 'Value_required';?>" value="<?php echo set_value('hospital'); ?>">

...
<div class="row">
	<div class="col-md-12">
    	...
    	<!------CONTROL TABS END------>
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?superadmin/medical_labs/create" method="post" enctype="multipart/form-data">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="description" class="form-control" id="field-5" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="address" class="form-control" id="address"  data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="owner_name" class="form-control" id="owner_name"  data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="owner_mobile" class="form-control" id="owner_mobile"  data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" value="">
                        </div>
                    </div>
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="fname" class="form-control" id="field-2" value="">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="lname" class="form-control" id="field-2" value="">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-8"> 
                            <input type="email" name="email" class="form-control" id="field-7" value="">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="in_mobile" class="form-control" id="field-7" value="">
                        </div>
                    </div>
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="gender" class="form-control" data-validate="required" value="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="dob" class="form-control datepicker" id="field-2" value="" placeholder="<?php echo $this->lang->line('buttons')['dob'];?>" autocomplete="off">
                        </div>
                    </div>

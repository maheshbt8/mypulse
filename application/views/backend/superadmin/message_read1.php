...
foreach ($messages as $row):
    ...
    $sender_account_type_id = $sender[1];
    $sender_id = $sender[2];
    ?>
    <div class="mail-info">
        ...
        <div class="mail-sender " style="padding:7px;">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span><?php echo $this->db->get_where($sender_account_type, array($sender_account_type_id . '_id' => $sender_id))->row()->name; ?></span>
            </a>
        </div>
...
<?php echo form_open(base_url() . 'index.php?superadmin/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
<div class="mail-reply">
    <div class="compose-message-editor">
        <textarea row="5" class="form-control wysihtml5" data-stylesheet-url="<?php echo base_url();?>assets/css/wysihtml5-color.css" name="message"
                  placeholder="<?php echo ucfirst('reply_message'); ?>" id="sample_wysiwyg" required></textarea>
    </div>
    <br>
    <!-- File adding module -->
    <div class="">

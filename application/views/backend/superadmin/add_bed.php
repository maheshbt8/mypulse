            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>index.php?superadmin/bed/create" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="form-group">
						<label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('wards'); ?></label>
		                    <div class="col-sm-5">
                    ...
                    <div class="form-group">
						<label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('bed_status'); ?></label>
		                    <div class="col-sm-5">
		                        <select name="bed_status" class="form-control" id="status"  data-validate="required" data-message-required="<?php echo 'Value_required';?>" value="">
		                            <option value=""><?php echo get_phrase('select_bed_status');?></option>
		                            <option value="1" selected><?php echo get_phrase('available');?></option>
                                    <option value="2"><?php echo get_phrase('not_available');?></option>
			                    </select>
			                </div>
					</div>

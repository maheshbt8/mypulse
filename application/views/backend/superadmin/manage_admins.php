    ...
    <tbody>
        ...
        ?>   
            <tr>
                ...
                <td>
                <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?superadmin/hospital_admins/delete/<?php echo $row['admin_id'] ?>');" title="Delete"><i class="glyphicon glyphicon-remove"></i>
                </a>
                <?php if($row['is_email'] == '2'){?>
                <a href="<?php echo base_url(); ?>index.php?superadmin/resend_email_verification/hospitaladmins/admin/<?php echo $row['unique_id'] ?>" title="Verification Mail"><i class="glyphicon glyphicon-envelope"></i></a><?php }?>
                </td>
            </tr>
        <?php $i++;} ?>
    </tbody>

        ...
        <?php $i=1;foreach ($receptionist_info as $row) { ?>   
            <tr>
               ...
               <td>
                ...
                <a href="<?php echo base_url(); ?>index.php?superadmin/resend_email_verification/receptionist/receptionist/<?php echo $row['unique_id'] ?>" title="Verification Mail"><i class="glyphicon glyphicon-envelope"></i></a><?php }?>
                </td>
            </tr>
        <?php } ?>
    </tbody>

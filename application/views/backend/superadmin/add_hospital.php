	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <form action="<?php echo base_url()?>index.php?superadmin/hospital/create/" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
<div class="row">
    <div class="col-md-6">
        ...
        <div class="panel panel-primary" data-collapsed="0">     
            ...
            <div class="panel-body">
					...
					<div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="md_name" class="form-control" id="field-8"  data-validate="required" data-message-required="<?php echo 'Value_required';?>" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="md_phone" class="form-control" id="field-9"  data-validate="required" data-message-required="<?php echo 'Value_required';?>" value="">
                        </div>
                    </div>
                <div class="form-group">
            ...
            <div class="panel-body">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="from_date" class="form-control" id="field-5"   value="">
                        </div>
                    </div>
                             ...
                             <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('To Date'); ?></label>

                        <div class="col-sm-8">
                            <input type="date" name="till_date" class="form-control" id="field-5"   value="">
                        </div>
                    </div>

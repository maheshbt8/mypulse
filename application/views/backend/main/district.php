...
<a href="#" onclick="confirm_modal('<?php echo base_url();?>main/district/delete/<?php echo $row['district_id'];?>');" id="dellink_2" class="delbtn" data-toggle="modal" data-target=".bs-example-modal-sm" data-id="2" title="Delete"><i class="glyphicon glyphicon-remove"></i>
</a>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    ...
                    <div class="form-group">     
                        ...
                        <div class="col-sm-5">
                            <select name="state_id" id="state" class="form-control select2" data-validate="required" data-message-required="<?php echo 'Value Required';?>" value=""  onchange="return get_branch(this.value)">

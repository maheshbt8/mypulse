...
<div class="row">
        ...
        <div class="panel panel-primary" data-collapsed="0">
         <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="fname" class="form-control" id="fname" data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" value="<?=$row['name']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="mname" class="form-control" id="mname" value="<?=$row['mname']?>"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="lname" class="form-control" id="lname"  data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" value="<?=$row['lname']?>"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="description" class="form-control" id="description"  data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" value="<?=$row['description']?>"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
  ...
  <div class="modal fade" id="myModal" role="dialog">
         ...
         <div class="panel-body">
                ...
                <div class="col-sm-10 control-label col-sm-offset-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="status" class="form-control" data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" value=""<?php if(($account_type != 'superadmin')||$row['isDeleted']=='2'){echo "disabled";}?>>
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="gender" class="form-control" id="gender" value=""<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="dob" class="form-control" id="dob" placeholder="<?php echo $this->lang->line('labels')['dob'];?>" onchange="return calculate_age(this.value)" value="<?=$row['dob']?>" autocomplete="off"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group" hidden="">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="aadhar" class="form-control" id="aadhar" value="<?=$row['address']?>"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="address" class="form-control" id="address" value="<?=$row['address']?>"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <img src="<?=base_url('User-Image/'.$row['user_id']);?>" alt="..." value="">
                                ...
                                <div>
                                    <span class="btn btn-white btn-file">
                                        ...
                                        <input type="file" name="userfile" accept="image/*" id="userfile" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                                    </span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">     
                        ...
                        <div class="col-sm-8">
                            <select name="country" class="form-control select2" id="country" value=""  onchange="return get_state(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                       ...
                       <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('state'); ?></label>
                            <div class="col-sm-8">
                                <select name="state" class="form-control select2" id="select_state" value=""  onchange="return get_district(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                       ...
                       <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('district'); ?></label>
                            <div class="col-sm-8">
                                <select name="district" class="form-control select2" id="select_district"  value=""  onchange="return get_city(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                                    <?php 
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('city'); ?></label>
                            <div class="col-sm-8">
                                <select name="city" class="form-control select2" id="select_city" value="" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
    ...
    <div class="col-md-12">
         ...
         <div class="panel-body">
                <div class="row">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="blood_group" class="form-control select2" id="blood_group" value="" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="age" class="form-control" id="age" value="<?=$row['age']?>" readonly <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="height" class="form-control" id="height" value="<?=$row['height']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="weight" class="form-control" id="weight" value="<?=$row['weight']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="blood_pressure" class="form-control" id="blood_pressure" value="<?=$row['blood_pressure']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="sugar_level" class="form-control" id="sugar_level" value="<?=$row['sugar_level']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="health_insurance_provider" class="form-control" id="health_insurance_provider" value="<?=$row['health_insurance_provider']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="health_insurance_id" class="form-control" id="health_insurance_id" value="<?=$row['health_insurance_id']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="family_history" class="form-control" id="family_history" value="<?=$row['family_history']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="past_medical_history" class="form-control" id="past_medical_history" value="<?=$row['past_medical_history']?>" <?php if(($account_type != 'superadmin' && $account_type != 'users')||$row['isDeleted']=='2'){echo "disabled";}?>>
                        </div>
                    </div>
        ...
        <?php if(($account_type == 'superadmin' || $account_type == 'users')&&$row['isDeleted']=='1'){?>

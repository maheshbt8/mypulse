    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>main/city/update/<?=$row['city_id']?>" method="post" enctype="multipart/form-data">
    <div class="row">
    <div class="col-md-12">
         ...
         <div class="panel-body">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">     
                        ...
                        <div class="col-sm-6">
                            <select name="state_id" class="form-control" data-validate="required" data-message-required="<?php echo 'Value_required';?>" id="state"   value=""  onchange="return get_district1(this.value)">
                    ...
                    <br/>
                    <div class="form-group">     
                        <label for="field-ta" class="col-sm-4 control-label"><?php echo $this->lang->line('labels')['selectDistrict'];?></label> 
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label"><?php echo ucfirst('City Name');?></label>
                    <div class="col-sm-6">

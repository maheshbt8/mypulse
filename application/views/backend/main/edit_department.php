...
?>
    <div class="row">
   	...
   	<div class="form-group">
						...
						<div class="col-sm-8">
							<select name="hospital" class="form-control selectbox" id="hospital" data-validate="required" data-message-required="<?php echo $this->lang->line('validation')['value_required'];?>" onchange="return get_branch(this.value)">

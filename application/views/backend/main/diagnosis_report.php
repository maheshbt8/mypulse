<?php
$pid=$param2;
$prec_id=$this->db->get_where('prescription', array('patient_id' => $param2))->row_array();
$diagnosis_report_info  = $this->db->get_where('diagnosis_report', array('prescription_id' => $prec_id['prescription_id']))->result_array();

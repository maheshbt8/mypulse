<?php
$row=$this->crud_model->select_city_info_id($param2);
?>
            ...
            <div class="padded">
                	<div class="form-group">     
                      ...
                      <div class="form-group">     
                        ...
                        <div class="col-sm-5">
                            <select name="state_id" class="form-control" data-validate="required" data-message-required="<?php echo 'Value_required';?>" id="state_edit"   value=""  onchange="return get_district1(this.value)">
                    ...
                    <div class="form-group">     
                        <label for="field-ta" class="col-sm-3 control-label">District</label> 

                        <div class="col-sm-5">
                            <select name="district_id" class="form-control" data-validate="required" data-message-required="<?php echo 'Value_required';?>" id="district_edit"   value=""  onchange="">
                                <option value="">Select District</option>
                                <?php 
                                $state = $this->crud_model->select_district($row['state_id']);
                                foreach($state as $row2){?>
                                <option value="<?php echo $row2['district_id'] ?>" <?php if($row2['district_id']==$row['district_id']){echo 'selected';}?>><?php echo $row2['dist_name'] ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="name" value="<?php echo $row['city_name'];?>"

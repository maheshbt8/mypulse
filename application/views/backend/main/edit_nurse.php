...
<?php }?>
        ...
        <!------CONTROL TABS END------>
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>main/edit_nurse/<?php echo $nurse_id; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="text" name="fname" class="form-control" id="fname" value="<?=$row['name']?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="mname" class="form-control" id="field-2" value="<?=$row['mname']?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="lname" class="form-control" id="field-3" value="<?=$row['lname']?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="description" class="form-control" id="description" value="<?=$row['description']?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="email" name="email" class="form-control" id="email" value="<?=$row['email']?>" <?php if($row['email_verify']==1 || ($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')){echo 'readonly';}?>>
                <?php if($account_type == 'superadmin' || $account_type == 'hospitaladmins' || $account_type == 'nurse'){
                if($row['email_verify']==1){?>
                <span class="verifiedsuccess">Email Verified</span>
                <?php }elseif($row['email_verify']==2){?>
                <span class="notverified">Email Not Verified <a href="<?php echo base_url(); ?>main/resend_email_verification/nurse/nurse/<?php echo $row['unique_id'] ?>" title="Verification Mail" class="hiper">Re-Send Verification Mail</a></span>
                <?php }}?>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="hidden" name="user_id" id="user_id" value="<?=$row['nurse_id'];?>">
                 ...
                 <?php if($account_type=='superadmin'){?>
                  <div class="form-group">     
                    <label for="field-ta" class="col-sm-3 control-label"> <?php echo get_phrase('hospital'); ?></label> 
                        <div class="col-sm-8">
                            <select name="hospital" class="form-control select2" value="<?php echo set_value('hospital'); ?>"  onchange="return get_branch(this.value)"<?php if($row['row_status_cd']=='0'){echo "disabled";}?>>
                ...
                <?php }?>
                  <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"> <?php echo get_phrase('branch'); ?></label>
                            <div class="col-sm-8">
                                <select name="branch" class="form-control select2" id="branch"   value="<?php echo set_value('branch'); ?>"  onchange="return get_department_all(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                                    <option value=""><?php echo 'Select Branch';?></option>
                                     <?php 
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"> <?php echo get_phrase('department'); ?></label>
                            <div class="col-sm-8">
                                <select name="department" class="form-control select2" id="department" value="<?php echo set_value('department'); ?>"  onchange="return get_doctor(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                                     <?php 
                                $admins = $this->crud_model->select_department_info_by_branch_id($row['branch_id']);
                                ?>
                                <option value=""><?php echo 'Select Departments';?></option>
                      ...
                      <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('doctor'); ?></label>
                            <div class="col-sm-8">
                                <select multiple name="doctor[]" class="form-control select2" id="select_doctor" value="<?php echo set_value('doctor[]'); ?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                                    <option value=""><?php echo 'Select Doctors';?></option>
                                      <?php 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="status" class="form-control" id="status" value="<?php echo set_value('status'); ?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
    ...
    <div class="col-md-12">
     ...
     <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="gender" class="form-control" id="gender" value="<?php echo set_value('gender'); ?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="dob" class="form-control" id="dob" value="<?=$row['dob']?>" placeholder="<?php echo get_phrase('date_of_birth'); ?>" autocomplete="off"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="address" class="form-control" id="address" value="<?=$row['address']?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                    ...
                    <img src="<?=base_url('Nurse-Image/'.$row['nurse_id']);?>" alt="...">
                                ...
                                <div>
                                    <span class="btn btn-white btn-file">
                                        ...
                                        <input type="file" name="userfile" accept="image/*" id="userfile" value="<?php echo set_value('userfile'); ?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                                    </span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">     
                        ...
                        <div class="col-sm-8">
                            <select name="country" class="form-control select2" value=""  onchange="return get_state(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                       ...
                       <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo $this->lang->line('labels')['selectState'];?></label>
                            <div class="col-sm-8">
                                <select name="state" class="form-control select2" id="state"  value=""  onchange="return get_district(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                       ...
                       <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo $this->lang->line('labels')['selectDistrict'];?></label>
                            <div class="col-sm-8">
                                <select name="district" class="form-control select2" id="district" value=""  onchange="return get_city(this.value)"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo $this->lang->line('labels')['selectCity'];?></label>
                            <div class="col-sm-8">
                                <select name="city" class="form-control select2" id="city" value="" <?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                                    <option value=""><?php echo $this->lang->line('labels')['select_city'];?></option>
                                    <?php 
    ...
    <div class="col-md-12">
        ...
        <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="qualification" class="form-control" id="qualification" value="<?=$row['qualification']?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="experience" class="form-control" id="experience" value="<?=$row['experience']?>"<?php if(($account_type != 'superadmin' && $account_type != 'hospitaladmins' && $account_type != 'nurse')|| $row['row_status_cd']=='0'){echo "disabled";}?>>
                        </div>
                    </div>
                </div>
                    </div>    
                ...
                <?php if(($account_type == 'superadmin' || $account_type == 'hospitaladmins' || $account_type == 'nurse') && $row['row_status_cd']!='0'){?>
            <input type="submit" class="btn btn-success" value="Update">
            <?php }?>&nbsp;&nbsp;
                        <input type="button" class="btn btn-info" value="<?php if(($account_type == 'superadmin' || $account_type == 'hospitaladmins' || $account_type == 'nurse') && $row['row_status_cd']!='0'){echo get_phrase('cancel');}else{echo get_phrase('close');} ?>" onclick="window.location.href = '<?= $this->session->userdata('last_page'); ?>'">
                    </div> 
                    </div>
                    </div> 
                    </div>
...
<script>
     ...
     $.ajax({
       ...
       function opt_submit(form) {
            $.ajax({
            type: 'post',
            url: '<?php echo base_url();?>main/opt_verification/nurse/nurse/',
            data: $('form').serialize(),
            success: function (response) {
                if(response == 1){

            ...
            <div class="panel-body">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">     
                        ...
                        <div class="col-sm-8">
                            <select name="hospital" class="form-control select2" value="<?php echo set_value('hospital'); ?>" data-validate="required" data-message-required="<?php echo get_phrase('Value_required');?>" onchange="return get_branch(this.value)">
                ...
                <?php }?>
                  <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"> <?php echo get_phrase('branch'); ?></label>
                            <div class="col-sm-8">
                                <select name="branch" class="form-control select2" data-validate="required" data-message-required="<?php echo get_phrase('Value_required');?>" id="select_branch"   value="<?php echo set_value('branch'); ?>"  onchange="return get_department(this.value)">
                ...
                <?php }?>
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"> <?php echo get_phrase('department'); ?></label>
                            <div class="col-sm-8">
                                <select name="department" class="form-control select2" data-validate="required" data-message-required="<?php echo get_phrase('Value_required');?>" id="select_department" value="<?php echo set_value('department'); ?>"  onchange="return get_doctor(this.value)">
    ...
    <div class="col-md-12">
     ...
     <div class="panel-body">
                ...
                <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <select name="country" class="form-control select2" value="<?php echo set_value('country'); ?>"  onchange="return get_state(this.value)">

<div class="row">
	<div class="col-md-12">
    	...
    	<!------CONTROL TABS END------>
         <form role="form" class="form-horizontal form-groups-bordered validate" action="<?php echo base_url(); ?>main/add_nurse/" method="post" enctype="multipart/form-data">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="mname" class="form-control" id="field-2" value="<?php echo set_value('mname'); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">     
                        ...
                        <div class="col-sm-8">
                            <select name="hospital" id="hospital" class="form-control select2" value="<?php echo set_value('hospital'); ?>" data-validate="required" data-message-required="<?php echo get_phrase('Value_required');?>" onchange="return get_branch(this.value)">
                ...
                <?php }?>
                  <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"> <?php echo get_phrase('branch'); ?></label>
                            <div class="col-sm-8">
                                <select name="branch" class="form-control select2" data-validate="required" data-message-required="<?php echo get_phrase('Value_required');?>" id="branch"   value="<?php echo set_value('branch'); ?>"  onchange="return get_department_all(this.value)">
                ...
                <?php }?>
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"> <?php echo get_phrase('department'); ?></label>
                            <div class="col-sm-8">
                                <select name="department" class="form-control select2" data-validate="required" data-message-required="<?php echo get_phrase('Value_required');?>" id="department" value="<?php echo set_value('department'); ?>"  onchange="return get_doctor(this.value)">
                      ...
                      <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('doctor'); ?></label>
                            <div class="col-sm-8">
                                <select multiple name="doctor[]" class="form-control select2" data-validate="required" data-message-required="<?php echo get_phrase('Value_required');?>" id="select_doctor" value="<?php echo set_value('doctor[]'); ?>">
                                </select>
    ...
    <div class="col-md-12">
     ...
     <div class="panel-body">
                ...
                <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <select name="country" id="country" class="form-control select2" value="<?php echo set_value('country'); ?>"  onchange="return get_state(this.value)">
                        ...
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('city'); ?></label>
                            <div class="col-sm-8">
                                <select name="city" class="form-control select2" id="city" value="<?php echo set_value('city'); ?>"  >
                                    <option value=""><?php echo get_phrase('select_city
                                    _first'); ?></option>

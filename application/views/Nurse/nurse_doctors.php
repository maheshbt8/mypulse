<?php 
$nurdocids = array();
foreach($Result as $nurdoc){ 
$nurdocids[] = $nurdoc->doc_id; 
...
?>
				...
				<input type="hidden" name="nurseuserid" value="<?php echo $NurseUserID->user_id; ?>" />
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active fade in" id="tab1">
										...
										<div class="col-md-12">
											...
											<select name='doc_id[]' class='DoctorID form-control allowalphanumeric'  multiple='multiple'>
											<?php foreach($Doctors as $Doc){ ?>
											<?php //foreach($Result as $recdoc){ ?>
											<option value="<?php echo $Doc->id; ?>" <?php if(in_array($Doc->id,$nurdocids)){echo "selected='selected'";} ?>><?php echo $Doc->FullName;?></option>
											<?php } //} ?>
											</select> 
											</div>

	                ...
	                <div class="card ">
						<div class="card-head">
							...
							<div class="custome_card_header">
								<?php /*?><a class="btn btn-success m-b-sm addbtn" data-toggle="tooltip" href="javascript:void(0);" data-toggle="modal" data-target="#edit" style=""><?php echo $this->lang->line('buttons')['addNew'];?></a>
...
?><script type="text/javascript">
			...
			$(document).ready(function(){
				...
				var dt = $("#doctors").DataTable({
		            "processing": true,
		            "serverSide": true,
		            "ajax": "<?php echo site_url(); ?>/patients/getDTdoctors",
					"columns":[

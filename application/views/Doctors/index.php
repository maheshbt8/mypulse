	                    ...
	                    <div class="panel-body">
	                       <div class="table-responsive">
	                            <table id="doctors" class="display table" cellspacing="0" width="100%">
	                                <thead>
	                                    <tr><th style="width:10px"></th><th>Doctor</th><th>Hospital</th><th>Branch</th><th>Department</th><th>Status</th><th width="20px">#</th>
	                                    </tr>
	                                </thead>
									...
									<div role="tabpanel" class="tab-pane fade in" id="tab4">
										...
										<div class="col-md-12">
											<div class="form-group col-md-6">
												...
												<input class="form-control" type="text" placeholder="Specilization" name1="specilization" id="specilization" />
											</div>
											<div class="form-group col-md-6">

		...
		$(document).ready(function(){
            ...
            function loadTable(){
                ...
                $("#patients").DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "<?php echo site_url(); ?>/doctors/getDTInPatient?j_sd="+_j_sd+"&j_ed="+_j_ed+"&l_sd="+_l_sd+"&l_ed="+_l_ed+"&st="+st
                });
                ...
                $(document).on('click','.editinpatient',function(){
                    ...
                    $.ajax({
                            ...
                            success: function(res) {
                                ...
                                $( "#patient_reason" ).prop( "disabled", false );
                                $( "#ptStatus" ).prop( "disabled", false );

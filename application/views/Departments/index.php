	                    ...
	                    <div class="panel-heading clearfix">
							<div class="">
								<div class="custome_col8">
									<h4 class="panel-title panel_heading_custome"><?php echo $this->lang->line('departments');?></h4>
								</div>
								<div class="custome_col4">
									<div class="panel_button_top_right">
										...
										<a class="btn btn-primary m-b-sm exportBtn" data-at="departments" href="javascript:void(0);" data-toggle="modal" data-target="#export" style="margin-left:10px"><?php echo $this->lang->line('buttons')['export'];?></a>
									</div>
								</div>
								<br>
							</div>

        ...
        <div class="row">
            <div class="state-overview">
                <div class="col-lg-3 col-sm-6">
                    <a href="<?php echo site_url();?>/medical_lab/patient">
                    <div class="overview-panel purple">
                        <div class="symbol">
                            <i class="fa fa-users"></i>
                        </div>
                        <div class="value white">
                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="<?php echo $states['total_pat'];?>"><?php echo $states['total_pat'];?></p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <a href="<?php echo site_url();?>/medical_lab/reports?s=0">
                    <div class="overview-panel green-bgcolor">
                        <div class="symbol">
                            <i class=" glyphicon glyphicon-list-alt"></i>
                        </div>
                        <div class="value white">
                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="<?php echo $states['total_outstanding_report'];?>"><?php echo $states['total_outstanding_report'];?></p>
                            <p><?php echo $this->lang->line('Outstanding_report');?></p>
                        </div>
                    </div>
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <a href="<?php echo site_url();?>/medical_lab/reports?s=1">
                    <div class="overview-panel orange">
                        <div class="symbol">
                            <i class="fa fa-check-square"></i>
                        </div>
                        <div class="value white">
                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="<?php echo $states['total_complete_report'];?>"><?php echo $states['total_complete_report'];?></p>
                            <p><?php echo $this->lang->line('Complete_report');?></p>
                        </div>
                    </div>
                    </a>
                </div>

        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <div class="panel-body" id="profileBody">
                    <form action="<?php echo site_url(); ?>/medical_store/updateabout" method="post" id="form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" rows="5"  placeholder="<?php echo $this->lang->line('labels')['aboutMedStorePlaceholder'];?>" name="description" id="description"><?php echo $about['description'];?></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group col-md-6">

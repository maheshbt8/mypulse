...
?>
		...
		<div id="main-wrapper">
	        <div class="row">
	            <div class="col-md-12">
	                <div class="card">
						<div class="card-head">
							<header><?php echo $this->lang->line('hospital_admin');?></header>
	                    ...
	                    <div class="card-body">
							<table id="hospital_admin" class="table table-striped table-bordered table-hover table-checkable order-column valign-middle">
								<thead>
									<tr>
		...
		<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<form action="<?php echo site_url(); ?>/hospital_admin/update" method="post" id="form" enctype="multipart/form-data" autocomplete="off">

	...
	<section class="wthree-row w3-about py-5">
		<div class="container py-md-4 mt-md-3">
			...
			<div class="card-deck mt-md-5 pt-5">
				  <div class="card">
					<img src="<?=base_url('assets/front/')?>images/g7.jpg" class="img-fluid" alt="Card image cap">
				  ...
				  <div class="card">
					<img src="<?=base_url('assets/front/')?>images/g6.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
				  ...
				  <div class="card">
					<img src="<?=base_url('assets/front/')?>images/g8.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
